"""Slice 25: deterministic terminal demonstration of set_feature_flag --
a genuinely non-user-management consequential tool, governed by the
exact same guarded pipeline (registry, policy, selector hashing, budget,
postcondition, audit, repair guidance) as delete_users/deactivate_users,
operating on a filesystem-backed feature-flag resource instead of the
